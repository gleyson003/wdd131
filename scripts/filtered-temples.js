...
// Last modification and current year to Footer
...
// Function to filter temples based on the criteria
...
// Function to render temples based on the filtered array
...
// Function to filter and render temples based on the criteria
function filterAndRenderTemples(criteria) {
...
document.querySelectorAll('nav a').forEach(item => {
  item.addEventListener('click', () => {
    const filterCriteria = item.textContent.trim();
    filterAndRenderTemples(filterCriteria);
  });
});

// Initial render
filterAndRenderTemples('Home');